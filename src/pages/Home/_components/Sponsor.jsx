        ...
        <div className='col-span-12 flex flex-col items-center gap-12 lg:gap-22 text-center'>
            ...
            <div className='relative w-full md:w-auto overflow-hidden md:overflow-visible'>
                ...
                <div className='mx-auto overflow-hidden sm:overflow-visible'>
                    <img src="/images/tools-before-notion-V2.png" alt="icons" className='max-w-sm sm:max-w-lg md:max-w-full mx-auto' />
                </div>
                <img src="/images/tools-strikethrough-V2.png" alt="line" className='absolute bottom-4 right-20 md:right-0 mix-blend-multiply w-4/5 md:w-full' />
                <img src="/images/pencil-peek-illustration-V2.png" alt="small girl" className='md:hidden absolute -right-10 sm:-right-8 -bottom-10 sm:-bottom-8' />
                <img src="/images/giant-pencil-illustration.png" alt="giant girl" className=' hidden md:block absolute -top-8 -right-20 w-1/3' />
            </div>
