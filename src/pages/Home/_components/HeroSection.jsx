        ...
        <>
            <div className='flex flex-col items-center gap-8 justify-center'>
                <div className='w-full sm:w-2/3 md:w-full pt-8 md:pt-9 lg:pt-14 xl:pt-16'>
                    <h1 className='text-5xl md:text-6xl text-center font-bold '>Creative, fun, art, joy</h1>
                </div>
                <p className='text-2xl font-medium text-center w-2/3 mx-auto'>Unleash your creativity with vibrant doodles <br /> that spark joy and imagination</p>
            ...
            <div className='relative mt-0 lg:mt-8 max-w-screen-2xl mx-auto mb-8 lg:mb-32'>
                <div className='overflow-hidden'>
                    <div className='w-screen lg:w-fit'>
                        <img src="/doodles/LongHairDoodle.svg" alt="Long Hair Doodle" className='max-w-none lg:w-full ml-6' loading='eager' height={1080} width={1920} />
                    </div>
                </div>
