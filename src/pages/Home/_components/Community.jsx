    ...
    return (
        <div className='col-span-10 col-start-2 text-center space-y-4'>
            ...
            <div className='overflow-hidden'>
                <img src="/doodles/faces.png" alt="faces doodle from freePics" className='w-screen mx-auto md:!mt-12' height={100} width={800} />
            </div>
            <div className='grid grid-cols-6 gap-6 text-left'>
                ...
                <Card className="col-span-6 md:col-span-3" title="An always-on support network" desc="Swap setups and share tips in over 149 online communities." image="/images/socialMedia.avif" />
                <Card className="col-span-6 md:col-span-3" title="Choose your language" desc="Doodle currently supports English, Korean, Japanese, French, German, Spanish, and Portuguese. With more to come!" image="/images/languages.avif" />
